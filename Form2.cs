...
namespace Form1
{
    ...
    public partial class Form2: Form
    {
        ...
        private string[] buttonTexts = { "Book Ticket", "Fixtures", "Vote " };
            ...
            buttonTexts = new string[]
{
    ...
    "Vote"
            ...
            button2.Text = "→";  // Right arrow
            button2.Font = new Font("Segoe UI", 20, FontStyle.Bold); // Make the arrow clear
            button2.BackColor = Color.White;
            button2.ForeColor = Color.Black;
            button2.FlatStyle = FlatStyle.Flat;
            button2.FlatAppearance.BorderSize = 0;
            button2.Size = new Size(50, 50); // Optional: resize button for aesthetics
